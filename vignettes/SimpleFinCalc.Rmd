...
# then returns the calculated value. The regular payment amount.

# Using user variables:
testP<-1000
testR<-5
testY<-10
annuity_payment(testF,testR,testY)
# Therefore if a person will has $1000 in an annuity, at an annual Rate of .05%, 
# receiving payments for 10 Years; their regular payment is ~$6139.133!
